...
SECRET_KEY = 'django-insecure-a%ii-t0i1rej6+gkjxb^(i5*8oh&3y4al6d_dpffgt-i2!oz7p'
...
MIDDLEWARE = [
    ...
    # Middleware creado para cargar el lenguaje del usuario
    "concesionaria.lang_middleware.UserLanguageMiddleware"
]
